...
export class SSEService {
    ...
    registerClient(userId: string, userRole: string, reply: FastifyReply): void {
        // Configuration SSE headers
        const origin = (reply.request.headers.origin as string) || 'http://localhost:3000';
    ...
    private unregisterClient(userId: string, reply: FastifyReply): void {
